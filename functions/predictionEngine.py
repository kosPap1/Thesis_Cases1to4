...
def predictionEngine1(loadTrainDayTarget, loadTrainDayMinus1, loadTrainDayMinus7, loadTrainDayMinus365, loadTestDayTarget,
    ...
    MLPreg = MLPRegressor(hidden_layer_sizes=(64, 64, 64), activation="relu", solver='adam', random_state=1,
                          max_iter=1000, learning_rate='adaptive', verbose=False).fit(trainSetX, trainSetY.ravel())
